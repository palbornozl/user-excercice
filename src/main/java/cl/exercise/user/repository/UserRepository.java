...
public interface UserRepository extends JpaRepository<UserEntity, Long> {
    ...
    @Modifying
    @Query(
            value = "UPDATE EXERCISE.TBL_USER SET last_login = current_timestamp, token = :token WHERE id = :id",
            nativeQuery = true)
    void updateUserLastLogin(@Param("id") UUID idUser, @Param("token") String token);
}
